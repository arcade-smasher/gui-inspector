...
public final class FillData extends AlternatingDisplayNodeData implements DrawCallData {
	private final int x1;
	private final int y1;
	private final int x2;
	private final int y2;

	public FillData(String display, String altDisplay, Object[] details, int x1, int y1, int x2, int y2) {
